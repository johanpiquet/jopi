...
import {logOutUser, mustHydrate, useRefresh, useFormSubmit, useUserInfos} from "jopi-rewrite-ui";
    ...
    if (infos) {
        ...
        return <div className="w-full flex flex-col items-center justify-center mt-20">
            <form onSubmit={submitForm}
                ...
                <div
                    className="flex items-center mt-6 w-full bg-transparent border border-gray-300/60 h-12 rounded-full overflow-hidden pl-6 gap-2">
